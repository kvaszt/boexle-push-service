...
import { startHousekeeping } from './imap/poller';
...
// Start IMAP IDLE loops
idleManager.startAll();

// Start periodic maintenance (DB cleanup)
startHousekeeping();
...
async function shutdown(): Promise<void> {
  ...
  try {
    ...
    console.warn('[Böxle Backend] IdleManager shutdown warning:', err);
  }
  try {
    closeProvider();
  } catch {
